...
public class NetServerHandler extends NetHandler {
	...
	public void handlePlace(Packet15Place packet15Place1) {
		int i2 = packet15Place1.xPosition;
		int i3 = packet15Place1.yPosition;
		int i4 = packet15Place1.zPosition;
		int i5 = packet15Place1.direction;
		...
		if(i7 > 16) {
			ItemStack itemStack8 = new ItemStack(packet15Place1.id);
